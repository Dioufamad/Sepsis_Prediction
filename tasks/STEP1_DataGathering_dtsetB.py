...
# input_directory = Prefix_in_absolute_path + "/Sepsis_Prediction/data/input_data/used_data/training_setB_test"
# - to use all the files
input_directory = Prefix_in_absolute_path + "/Sepsis_Prediction/data/input_data/used_data/training_setB"

...
# input_directory = Prefix_in_absolute_path + "/Owkin_Test1_Diouf_Amad/data/input_data/used_data/training_setB_test"
# - to use all the files
input_directory = Prefix_in_absolute_path + "/Owkin_Test1_Diouf_Amad/data/input_data/used_data/training_setB"
...
# """
# Number of patients for which data has been found and made into a table :  20000
...
full_table = np.vstack(files_tables)  # full_table.shape is 761995x41 for tr_setB
...
# fullname_file_of_df_full_table = output_directory+"/"+"dtsetB_forEDA_test_V1.csv" # for test
# df_full_table.to_csv(fullname_file_of_df_full_table, header=True, index=False)
# print("File dtsetB_forEDA_test_V1 saved !")

# - version being saved : the full table
# df to save is df_full_table
fullname_file_of_df_full_table = output_directory+"/"+"dtsetB_forEDA_full_V1.csv"
df_full_table.to_csv(fullname_file_of_df_full_table, header=True, index=False)
print("File dtsetB_forEDA_full_V1 saved !")

...
# input_file = Prefix_in_absolute_path + "/Sepsis_Prediction/data/output_data/after_step1_data_gathering/dtsetA_forEDA_test_V1.csv"
# - to use the full file
input_file = Prefix_in_absolute_path + "/Sepsis_Prediction/data/output_data/after_step1_data_gathering/dtsetA_forEDA_full_V1.csv"
